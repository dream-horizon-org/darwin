# Darwin Spark
Darwin Spark is a framework for building and running Spark applications at Dream11. It provides a set of utilities and configurations to streamline the development process.

## Features
- **Complete data-connectivity for all Dream11 data-sources**: No additional configuration is required to connect to Dream11 data sources.
...
* pom.xml file is used to maintain dependencies for spark. This file is used by maven to resolve dependencies from maven central and d11 jfrog.
* Make sure to add a server in .m2/settings.xml for d11 jfrog repository.
  * Example:
    ```xml
    <server>
      <id>jfrog-d11</id>  <!-- must match <repository><id> -->
      <username>infraautomation@dream11.com</username>
